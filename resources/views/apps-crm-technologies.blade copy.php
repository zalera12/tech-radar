                            ...
                            <div class="modal fade" id="editCategoryModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form action="{{ route('categories.edit', $company->id) }}" method="POST"
                    ...
                    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="addCategoryModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content border-0">
                                ...
                                <form action="{{ route('categories.add', $company->id) }}" method="POST"
                                    autocomplete="off">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row g-3">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0">
                                <div class="modal-header bg-info-subtle p-3">
                                    ...
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                        id="close-delete-categoryModal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="text-center">
                                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                            <h4>Are you sure?</h4>
                                            <p class="text-muted mx-4 mb-0">Do you really want to delete
                                                these records? This process cannot be undone.</p>
                                        </div>
                                    </div>
                                    <form action="{{ route('categories.delete') }}" method="POST" autocomplete="off"
