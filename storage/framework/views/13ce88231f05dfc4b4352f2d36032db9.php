                    ...
                    <div class="modal fade" id="editCategoryModal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content border-0">
                                ...
                                <form
                                    action="/companies/categories/edit?permission=Edit Category Technology&idcp=<?php echo e($company->id); ?>"
                    ...
                    <div class="modal fade" id="deleteCategoryModal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0">
                                ...
                                <form
                                    action="/companies/categories/delete?permission=Delete Category Technology&idcp=<?php echo e($company->id); ?>"
                                    ...
                                    <input type="hidden" value="<?php echo e($user->name); ?>" name="user">
                                    <div class="modal-body">
