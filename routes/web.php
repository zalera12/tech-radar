...
Route::middleware(['web', 'authenticated'])->group(function () {
    ...
    Route::post('/companies/users/join', [DashboardController::class, 'joinCompanyUser'])->name('company-users.join');
    ...
    Route::middleware(['check.permission'])->group(function () {
        ...
        Route::get('/companies/technologies/{company}', [CompaniesController::class, 'technologiesCompanies'])
            ->middleware('check.permission:Read Company Technology')
            ->name('technologies.companies');
        Route::post('/companies/technologies/add', [CompaniesController::class, 'addTechnologiesCompanies'])
            ->middleware('check.permission:Add Company Technology')
        ...
        Route::get('/companies/pendingMember/{company}', [CompaniesController::class, 'pendingMemberCompanies'])
            ->middleware('check.permission:Read Pending Company User')
            ->name('companies.pendingMembers');
        ...
        Route::get('/companies/log/{company}', [LogController::class, 'index'])
            ->middleware('check.permission:Read Change Log')
            ->name('companies.changeLog');
...
// Membatasi akses ke route login jika sudah login
